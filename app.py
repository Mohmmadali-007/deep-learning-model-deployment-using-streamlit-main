...
def load_model():
    model = tf.keras.models.load_model(
        r'D:\study\sem 6\cloud project\deep-learning-model-deployment-using-streamlit-main\deep-learning-model-deployment-using-streamlit-main\plant_classifier.hdf5')
    return model
...
file = st.file_uploader(
    "Choose plant photo from computer", type=["jpg", "png"])
